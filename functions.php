...
add_action('wp_enqueue_scripts', function(){
	...
	wp_register_style('allpages',get_stylesheet_directory_uri() . '/assets/scss/all-pages.css', [], 1);
	wp_enqueue_style( 'allpages' );

	// charge le style selon le template de page chargé
	if ( is_page_template( 'templates/style1.php' ) ) {
		wp_register_style( 'style1', get_stylesheet_directory_uri() . '/assets/scss/style1.css',[],1);
