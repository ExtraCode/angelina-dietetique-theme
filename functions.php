...
add_action('wp_enqueue_scripts', function(){
	...
	if ( is_page_template( 'templates/style1.php' ) ) {
		wp_enqueue_style( 'style1', get_stylesheet_directory_uri() . '/assets/css/style1.css' );
		wp_enqueue_style( 'style1-responsive', get_stylesheet_directory_uri() . '/assets/css/style1-responsive.css' );
	}
